...
func (e *normal) appendAtEnd(_ rune) modeChanger {
	if e.finishOp {
		return nil
	}
	e.move(len(e.buf))
...
func (e *normal) insertFirstNonBlank(_ rune) modeChanger {
	if e.finishOp {
		return nil
	}
...
func (e *normal) deleteUnder(_ rune) (_ modeChanger) {
...
func (e *normal) deleteToEnd(_ rune) (_ modeChanger) {
